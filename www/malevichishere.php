...
<head>
	...
	<meta charset="utf-8">
    <title>Maleglitch :: #malevichishere :: ax710 :: y_a_v_a</title>
   	<meta name="keywords" content="Maleglitch, Kazimir Malevich, malevichishere, Malevich tattoo, Henk Schiffmacher, Stedelijk Museum Amsterdam">
...
body { padding: 0; margin: 0; text-align: center; overflow-x: hidden; }
img { border: none; }
.c { color: rgb(  0, 174, 239); }
.m { color: rgb(236,   0, 140); }
.y { color: rgb(255, 242,   0); }
body > div { width: 700px; margin: 0 auto 240px auto; text-align: left; }
body > div p { line-height: 1.8; font-size: 20px; }
@media screen and (max-width: 400px) {
    h1 { margin: 4px 0 8px 0; line-height: 1; }
    h1 a > img { width: 100%; height: auto; }
    h2 { margin: 0.4em 0; font-size: 22px; }
    body > div {
        width: 100%;
    }
    body > div img {
...
<body>
    <h1 id="header" title="Kazimir Maleglitch by ax710 and y-a-v-a - 2010"><a href="/"><img src="header.jpg" alt="Kazimir Maleglitch by ax710 and y-a-v-a - 2010"></a></h1>

        <div>
            <h1>#malevichishere</h1>
            <p>ax710 and y_a_v_a won the <a class="m" href="http://www.stedelijk.nl/malevichishere">#malevichishere contest</a> of the Stedelijk Museum Amsterdam in February 2014. This contest was held at the event of the <strong>Kazimir Malevich and the Russian Avant-garde</strong> exhibition. The idea was to send in a creative work, inspired by Kazimir Malevich's art. We sent in this site: <a class="c" href="/">Maleglitch.net</a>.</p>
            <img src="tattoo/Malevich_Tattoo_Hanky_Panky_Ruud_Akse-08a.jpg" alt="" width="700">
