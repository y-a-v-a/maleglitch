...
#image { height: 0px; display: block; margin: 0 auto; }
footer { width: 100%; text-align: center; display: block; margin: 10px 0; height: 71px; }
.dsR1 { width: 1280px; height: 67px; }
</style>
...
<body onload="setTimeout('myReload()', 20000)">
		...
		<script type="text/javascript">
		  var _gaq = _gaq || [];
		  _gaq.push(['_setAccount', 'UA-16179947-10']);
		  _gaq.push(['_setDomainName', 'maleglitch.net']);
